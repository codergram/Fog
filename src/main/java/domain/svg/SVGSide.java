...
public class SVGSide {
    ...
    private String skur() {
        ...
        if (roof.equals("Peak")) {
            svgText = new StringBuilder("<svg version=\"1.1\"\n" +
                    "         xmlns=\"http://www.w3.org/2000/svg\"\n" +
            ...
            for (double x = 0; x < 210; x = x + 10) {
                svgText.append("<rect x=\"").append((length - shedLength - 20) + x).append("\" y=\"95\" height=\"210\" width=\"10\"\n").append("style=\"stroke:#000000; \" fill=\"none\"/>");
            }
            ...
            for (double x = 0; x < 220; x = x + 10) {
                svgText.append("<rect x=\"").append((length - shedLength - 30) + x).append("\" y=\"30\" height=\"200\" width=\"10\"\n").append("style=\"stroke:#000000; \" fill=\"none\"/>");
            }
    ...
    private String carportTag() {
        ...
        if (roof.equals("Peak")) {
            svgText = new StringBuilder("<rect x=\"5\" y=\"15\" height=\"65\" width=\"5\"\n" +
                    "              style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>");
            
            for (double x = 0; x < ((length - 10) / 10); x++) {
                svgText.append("<rect x=\"").append(10 + (x * 10)).append("\" y=\"15\" height=\"65\" width=\"10\"\n").append("style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>");
            }
            
            svgText.append("<rect x=\"0\" y=\"5\" height=\"10\" width=\"").append(length).append("\"\n").append("style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>");
            
            svgText.append("<rect x=\"0\" y=\"80\" height=\"15\" width=\"").append(length).append("\"\n").append("              style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>\n").append("        <rect x=\"0\" y=\"85\" height=\"10\" width=\"").append(length).append("\"\n").append("              style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>\n").append("        <rect x=\"35\" y=\"95\" height=\"10\" width=\"").append(length - 65).append("\"\n").append("              style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>");
            
            svgText.append("<rect x=\"0\" y=\"0\" height=\"70\" width=\"10\"\n").append("              style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>\n").append("        <rect x=\"").append(length - 10).append("\" y=\"0\" height=\"70\" width=\"10\"\n").append("              style=\"stroke:#000000; fill: #fff\" transform=\"rotate(0)\"/>");
            
        } else {
            //minus 1 pixel da rammen er for lille pga tag drejning
            svgText = new StringBuilder("<rect x=\"1\" y=\"0\" height=\"20\" width=\"" + (length - 1) + "\"\n" +
