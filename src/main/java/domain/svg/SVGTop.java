...
public class SVGTop {
    ...
    private String vandretMal() {
        ...
        if (roof.equals("Peak")) {
            svgText = new StringBuilder("<line x1=\"75\"  y1=\"" + (fixedWidth - 10) + "\" x2=\"" + (fixedLength - 25) + "\"   y2=\"" + (fixedWidth - 10) + "\"\n" +
                    "          style=\"stroke: #000000;\n" +
                    "\tmarker-start: url(#beginArrow);\n" +
                    "\tmarker-end: url(#endArrow);\"/>\n" +
                    "\n" +
            ...
            svgText.append("<line x1=\"").append(fixedLength - 280).append("\"  y1=\"").append(fixedWidth - 50).append("\" x2=\"").append(fixedLength - 170).append("\"  y2=\"").append(fixedWidth - 50).append("\" style=\"stroke: #000000; marker-start: url(#beginArrow);marker-end: url(#endArrow);\"/>\n").append("        <text style=\"text-anchor: middle\" transform=\"translate(").append(fixedLength - 230).append(",").append(fixedWidth - 65).append(") rotate(0)\">110cm</text>\n").append("\n").append("        <line x1=\"").append(fixedLength - 170).append("\"  y1=\"").append(fixedWidth - 50).append("\" x2=\"").append(fixedLength - 60).append("\"  y2=\"").append(fixedWidth - 50).append("\" style=\"stroke: #000000; marker-start: url(#beginArrow);marker-end: url(#endArrow);\"/>\n").append("        <text style=\"text-anchor: middle\" transform=\"translate(").append(fixedLength - 120).append(",").append(fixedWidth - 65).append(") rotate(0)\">110cm</text>");
            ...
            for (double x = 0; x < (antalSpear); x++) {
                ...
                svgText.append("<line x1=\"").append(startPosition + (x * 89)).append("\"  y1=\"").append(fixedWidth - 50).append("\" x2=\"").append(startPosition + (x * 89) + 89).append("\"  y2=\"").append(fixedWidth - 50).append("\" style=\"stroke: #000000; marker-start: url(#beginArrow);marker-end: url(#endArrow);\"/>\n").append("    <text style=\"text-anchor: middle\" transform=\"translate(").append(startPosition + (x * 89) + 50).append(",").append(fixedWidth - 65).append(") rotate(0)\">89cm</text>");
                
                
            }
            
            if (rest > 0) {
                svgText.append("<line x1=\"").append(75).append("\"  y1=\"").append(fixedWidth - 50).append("\" x2=\"").append(startPosition).append("\"  y2=\"").append(fixedWidth - 50).append("\" style=\"stroke: #000000; marker-start: url(#beginArrow);marker-end: url(#endArrow);\"/>\n").append("    <text style=\"text-anchor: middle\" transform=\"translate(").append(75 + rest / 2).append(",").append(fixedWidth - 65).append(") rotate(0)\">").append(rest).append("cm</text>");
            }
            
        } else {
            svgText = new StringBuilder("<line x1=\"75\"  y1=\"" + (fixedWidth - 30) + "\" x2=\"" + (fixedLength - 25) + "\"   y2=\"" + (fixedWidth - 30) + "\"\n" +
                    "          style=\"stroke: #000000;\n" +
                    "\tmarker-start: url(#beginArrow);\n" +
                    "\tmarker-end: url(#endArrow);\"/>\n" +
                    "\n" +
    ...
    private String carportSpaer() {
        ...
        if (roof.equals("Peak")) {
            ...
            svgText = new StringBuilder("<rect x=\"" + (length - 30) + "\" y=\"0\" height=\"" + (width) + "\" width=\"4.5\"\n" +
            ...
            for (double x = 0; x < (antalSpear); x++) {
                ...
                svgText.append("<rect x=\"").append(startPosition + (x * 89)).append("\" y=\"0\" height=\"").append(width).append("\" width=\"4.5\"\n").append("              style=\"stroke:#000000; fill: #fff\"/>");
                
            }
            
            //Vandret midter spær
            svgText.append("<rect x=\"0\" y=\"").append(width / 2 - 2).append("\" height=\"4\" width=\"").append(length).append("\"\n").append("              style=\"stroke:#000000; fill: #fff\"/>");
            ...
            for (double x = 0; x <= (antalVandretspear); x++) {
                ...
                svgText.append("<rect x=\"0\" y=\"").append(0 + (x * 27)).append("\" height=\"4\" width=\"").append(length).append("\"\n").append("              style=\"stroke:#000000; fill: #fff\"/>");
                
            }
            
            for (double x = 0; x <= (antalVandretspear); x++) {
                
                svgText.append("<rect x=\"0\" y=\"").append((width - 4) - (x * 27)).append("\" height=\"4\" width=\"").append(length).append("\"\n").append("              style=\"stroke:#000000; fill: #fff\"/>");
    ...
    private String carportSpaerMal() {
        ...
        if (roof.equals("Peak")) {
            ...
            if (rest > 0) {
                svgText = new StringBuilder("<line x1=\"10\"  y1=\"" + (width + 20) + "\" x2=\"" + (rest + 10) + "\"  y2=\"" + (width + 20) + "\" style=\"stroke: #000000; marker-start: url(#beginArrow);marker-end: url(#endArrow);\"/>\n" +
            ...
            for (double x = 0; x < (antalSpear); x++) {
                ...
                svgText.append("<line x1=\"").append(startPosition + (x * 55)).append("\"  y1=\"").append(width + 20).append("\" x2=\"").append(startPosition + (x * 55) + 55).append("\"  y2=\"").append(width + 20).append("\" style=\"stroke: #000000; marker-start: url(#beginArrow);marker-end: url(#endArrow);\"/>\n").append("        <text style=\"text-anchor: middle\" transform=\"translate(").append(startPosition + (x * 55) + 32).append(",").append(width + 40).append(") rotate(0)\">55cm</text>");
    ...
    private String carportSpear() {
        ...
        if (roof.equals("Peak")) {
            ...
            for (double x = 0; x < (antalSpear); x++) {
                ...
                svgText.append("<rect x=\"").append(startPosition + (x * 55)).append("\" y=\"0\" height=\"").append(width).append("\" width=\"4.5\"\n").append("              style=\"stroke:#000000; fill: #fff\"/>");
