...
public class LocalPartslist implements PartslistServices {
  ...
  @Override
  public List<Part> addToPartslist(
    ...
    if (carport.getRoofType() == Carport.Roof.Flat) {
      ...
      localPartlist.add(calculateScrewStarWaterBoard());
      ...
      if (carport.hasShed()) {
        localPartlist.add(calculateLathsDoor());
        ...
        localPartlist.add(calculateBarnDoorHandleShed());
        localPartlist.add(calculateHingeShed());
      ...
      localPartlist.add(calculateRoofBinderRoofTiles());
      localPartlist.add(calculateUniversalRaftersRightPeak(carport));
      localPartlist.add(calculateUniversalRaftersLeftPeak(carport));
      localPartlist.add(calculateScrewStarWaterBoardPeak());
      localPartlist.add(calculateFittingScrewsUniversalFittingsPeak());
  ...
  private Part calculateFittingScrewsUniversalFittingsPeak() {
    Material material = null;
    ...
    for (Options o : optionsMaterials) {
      if (o.getType() == Options.Type.FittingScrews
          && o.getUsage() == Material.Usage.UniversalFittings) {
        material = o;
      }
    }
    return new Part(material, amount, des);
  ...
  private Part calculateScrewStarWaterBoardPeak() {
    Material material = null;
  ...
  private Part calculateRoofBinderRoofTiles() {
    Material material = null;
  ...
  private Part calculateBackstoneFittingsBackStone(Carport carport) {
    ...
    for (Options o : optionsMaterials) {
      if (o.getType() == Options.Type.BackstoneFittings
          && o.getUsage() == Material.Usage.BackStone) {
        material = o;
      }
    }
    return new Part(material, amount, des);
  ...
  private Part calculateAngleBracketShed(Carport carport) {
    ...
    int amount =
        (int) Math.ceil((carport.getShed().getLength() * carport.getShed().getWidth()) / 10000 * 3);
  ...
  private Part calculateHingeShed() {
    Material material = null;
  ...
  private Part calculateBarnDoorHandleShed() {
    Material material = null;
  ...
  private Part calculateLathsDoor() {
    Material material = null;
  ...
  private Part calculateScrewStarWaterBoard() {
    Material material = null;
