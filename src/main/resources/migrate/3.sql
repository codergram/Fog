...
-- ----------------------------
BEGIN;
INSERT INTO `orders` VALUES (9, 600, 780, '2020-12-06 19:49:09', 1, 3, 'New', 1, 30.00);
INSERT INTO `orders` VALUES (10, 300, 610, '2020-12-06 21:17:19', NULL, 4, 'New', 2, 30.00);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=296 DEFAULT CHARSET=utf8 COLLATE=utf8_danish_ci;
